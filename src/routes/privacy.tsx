      ...
      <main className="mx-auto max-w-4xl w-full px-6 py-16 flex-1">
        ...
        <div className="space-y-10 text-foreground/80 leading-relaxed font-serif text-lg">
          <section>
            ...
            <p className="mb-4">
              This Privacy Policy explains how we handle the minimal data necessary to operate our Service, how we process ephemeral communications via Ovii Chat, and your rights regarding your digital footprint. By utilizing Novario, you consent to the data practices described in this document.
            </p>
          </section>
          ...
          <section>
            <h2 className="text-2xl font-bold text-foreground mb-4 font-sans tracking-tight">3. Ephemeral Communications (Ovii Chat)</h2>
            <p className="mb-4">
              Novario features a highly secure, localized communication layer known as Ovii Chat. To ensure maximum privacy and security for our users, Ovii Chat is designed with strict ephemeral data retention policies:
            </p>
            <ul className="list-disc pl-8 space-y-2 mb-4">
              <li><strong>Temporary Storage:</strong> Messages, voice notes, and media transmitted through Ovii Chat are stored temporarily. Our systems are configured to automatically purge all communication data after a strictly defined expiration period (typically 8 days).</li>
              <li><strong>No Archival Backups:</strong> Once data expires, it is permanently destroyed. We do not maintain cold-storage backups of user conversations.</li>
              <li><strong>End-to-End Encryption:</strong> While in transit, all communications are encrypted using industry-standard TLS protocols. We do not actively monitor, transcribe, or scan the contents of your private communications.</li>
            </ul>
          </section>

          <section>
            <h2 className="text-2xl font-bold text-foreground mb-4 font-sans tracking-tight">4. Third-Party Data Processors and APIs</h2>
            <p className="mb-4">
          ...
          <section>
            <h2 className="text-2xl font-bold text-foreground mb-4 font-sans tracking-tight">5. Cookies and Local Storage</h2>
            <p className="mb-4">
          ...
          <section>
            <h2 className="text-2xl font-bold text-foreground mb-4 font-sans tracking-tight">6. Law Enforcement and Compliance</h2>
            <p className="mb-4">
              Although we collect minimal data, Novario complies with valid, legally binding requests from law enforcement agencies. If compelled by a court order, subpoena, or search warrant, we will disclose whatever limited technical telemetry (such as server access logs or active, unexpired Ovii Chat data) that may exist on our infrastructure at the exact moment the request is processed.
            </p>
            <p className="mb-4">
              Because of our ephemeral architecture, we cannot produce data that has already been automatically purged by our systems.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-bold text-foreground mb-4 font-sans tracking-tight">7. Children's Privacy</h2>
            <p className="mb-4">
          ...
          <section>
            <h2 className="text-2xl font-bold text-foreground mb-4 font-sans tracking-tight">8. Your Rights Under GDPR and CCPA</h2>
            <p className="mb-4">
          ...
          <section>
            <h2 className="text-2xl font-bold text-foreground mb-4 font-sans tracking-tight">9. Modifications to this Policy</h2>
            <p className="mb-4">
