...
import {
  ...
  deleteDoc, doc, Timestamp, setDoc, getDocs, getDoc, writeBatch, limit, increment, arrayUnion, arrayRemove
...
export function OViiChat({ onLock, password }: { onLock: () => void, password?: string }) {
  ...
  const copyBulkChat = () => {
    ...
    const formatted = textMsgs.map(m => {
      ...
      const sender = m.name || (m.uid === uid ? "Me" : "Ovii User");
                        ...
                        {!showNoLockSubmenu && !showPaintsSubmenu && (
                          <>
                            ...
                            >
                              ...
                              <div className="flex-1 text-left font-medium">Copy Chats</div>
                            </button>
                      ...
                      {!contextMsg.isDeleted && contextMsg.uid === "elevone" && (
                        <>
                          ...
                          <button
                            ...
                            className={`w-full flex items-center gap-4 px-5 py-3.5 text-[15px] font-medium ${isDarkMode ? "hover:bg-white/5 text-white" : "hover:bg-black/5 text-black"}`}
                          >
                            <CheckCircle2 className="w-[18px] h-[18px] opacity-60 text-primary" /> Select Multiple
                          </button>
                        </>
                      )}
